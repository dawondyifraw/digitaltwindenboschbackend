...
class Config:
    # InfluxDB connection - Load from environment variables
    INFLUX_URL = os.getenv("INFLUX_URL", "http://localhost:8086")
    INFLUX_TOKEN = os.getenv("INFLUX_TOKEN", "")  # Load from env, no default for security
    ...
    SENSOR_WINDOW_MINUTES = int(os.getenv("SENSOR_WINDOW_MINUTES", "720"))
